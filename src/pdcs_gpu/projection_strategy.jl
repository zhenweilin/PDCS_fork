...
return value is one of `:few`, `:moderate`, `:sufficient`, or `:massive`.
...
1. use `:few` for at most three blocks, unless an RSOC kernel (codes 23--25)
   is present;
2. use `:moderate` for at most 1,000 blocks or a structured cone of dimension
   at least 2,000;
3. use `:sufficient` for at most 60,000 blocks or a structured cone of
   dimension at least 150;
4. otherwise use `:massive`.
