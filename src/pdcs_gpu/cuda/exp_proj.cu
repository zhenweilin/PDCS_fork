...
#define PDCS_PROFILE_GRADIENT() ((void)0)
...
#define PDCS_PROFILE_TERMINATION(code) ((void)0)
#define PDCS_PROFILE_BRACKET(left, right) ((void)0)
#define PDCS_PROFILE_OUTPUT_FINITE(value) ((void)0)
