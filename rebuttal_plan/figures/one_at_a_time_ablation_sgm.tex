...
\begin{axis}[
  ...
  xmax=6.55,
  xtick={1,2,3,4,5,6},
  xticklabels={Full,No scaling,Fixed $\eta$,No restart,No reflection,No Halpern},
...
] coordinates {(1,30.896885) (2,64.753608) (3,30.384811) (4,600) (5,34.499499) (6,24.344226)};
\end{axis}
\end{tikzpicture}
\end{document}
